...
export function useTGF(url : string ) {
  const [dataTGF, setData] = useState<IResultStringArray>()
  const [loadingTGF, setLoading] = useState(false)
  const [errorTGF, setError] = useState('')
  ...
  return { dataTGF, errorTGF, loadingTGF }
}
